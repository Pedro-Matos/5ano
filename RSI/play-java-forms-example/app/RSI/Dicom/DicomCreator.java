...
public class DicomCreator {
    ...
    private HashMap<String, TID> TIDs;
    private HashMap<String, CID> CIDs;
    private HashMap<String, String> mapping_values;
    private HashMap<String, LinkedList<String>> real_values;
    ...
    private void PDF_Fields(DicomElement pdf_fields, int index){
        ...
        try{
            ...
            System.out.println("Language: "+tmp_l.get(index));
        }
        catch (Exception e){
        ...
        d3_o.putString(Tag.CodeMeaning, VR.LO, "Physical Examination Results");
        ...
        d4_o.putString(Tag.CodeMeaning, VR.LO, "Comparison to previous exams");
        ...
        d5_o.putString(Tag.CodeMeaning, VR.LO, "Findings");
        ...
        d6_o.putString(Tag.CodeMeaning, VR.LO, "Conclusions");
